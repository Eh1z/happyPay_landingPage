  ...
  return (
    <div className='px-10 lg:px-64 py-20 flex flex-col lg:flex-row justify-between items-center' id='crypto'>
      <div className='lg:pr-64'>
        ...
        <p className="w-full mb-5">Our platform offers a seamless and secure way to buy, sell, and manage giftcards & cryptocurrencies. You can navigate the exciting world of digital assets with confidence.</p>
        <Link to='footer'>

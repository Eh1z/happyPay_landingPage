...
const Hero = () => {
  return (
    <>
    <div className='flex flex-col lg:flex-row items-center justify-center  px-5 lg:px-32 py-20 lg:py-20 w-full'>
              ...
              <div className='lg:pl-20 py-20 lg:py-64 text-left '>
                ...
                <a href="#">
                  <button className='flex items-center justify-center hover:bg-[#fff2f2] bg-[#FF0000] hover:text-[#FF0000] text-white font-medium rounded-xl border-2 border-[#FF0000] px-8 py-5 ease-in-out transition-all duration-300 w-[200px]'>
                    <p>Get Started Now</p>
                  </button>
                </a>
              </div>
              ...
              <div className='flex justify-center items-center w-full artbox'>
                  ...
                  <div className='design-container'>
                    <div className='cylinder' style={{ backgroundColor: "gray" }}></div>
                    <img src="/src/assets/image.jpg" alt="" />
                    <img src="/src/assets/image.jpg" alt="" />
                  </div>
